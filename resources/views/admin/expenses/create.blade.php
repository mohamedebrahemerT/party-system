...
@section('content')
                  ...
                  <form role="form" action="{{url('/')}}/expenses" method="POST" enctype="multipart/form-data">
                    @csrf
          ...
          <div class="row">
            ...
            <div class="form-group col-md-4">
                ...
                <select name="TypesOfExpenses_id" class="form-control" >
                    ...
                    <option  @if (old('TypesOfExpenses_id') == $TypesOfExpenses->id)
                    selected
              ...
              <input type="text"  value="{{old('value')}}" placeholder="{{trans('trans.value')}}" class="form-control"    name="value"  required=""/>
          </div>

           <div class="form-group col-md-12">
                               <label class="control-label">{{trans('trans.desc')}}</label>
              <input type="text"  desc="{{old('desc')}}" placeholder="{{trans('trans.desc')}}" class="form-control"    name="desc"  required=""/>
          </div>
