...
@section('content')
                     ...
                     <a href="{{ url('/dashboard') }}"> 
                           @else
                            <a href="{{ url('/MerchantDashboard') }}">
                                ...
                                <li>
                                    <a href="{{url('/')}}/subCity">{{trans('trans.subCity')}}</a>
                                    <i class="fa fa-circle"></i>
                                </li>
                  ...
                  <form role="form" action="{{url('/')}}/subCity/{{$subCity->id}}" method="POST" enctype="multipart/form-data">
 					@csrf
 					{{ method_field('PATCH') }}

 					<input type="hidden" name="id" value="{{$subCity->id}}">


 					 <div class="form-group">
                               <label class="control-label">{{trans('trans.name')}}</label>
              <input type="text" placeholder="{{trans('trans.name')}}" class="form-control"  value="{{$subCity->name}}" name="name"  required=""/> 
          </div>

               <div class="form-group">
                               <label class="control-label">{{trans('trans.code')}}</label>
              <input type="text" placeholder="{{trans('trans.code')}}" class="form-control"  value="{{$subCity->code}}" name="code"  required="" /> 
          </div>
