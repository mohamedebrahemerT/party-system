...
@section('content')
                  ...
                  <form role="form" action="{{url('/')}}/adminShowCities" method="POST" enctype="multipart/form-data">
                    @csrf
              ...
              <input type="text" placeholder="{{trans('trans.name_ar')}}" class="form-control"    name="name_ar"  required=""/> 
          </div>

           <div class="form-group">
                               <label class="control-label">{{trans('trans.ProvinceCode')}}</label>
              <input type="text" placeholder="{{trans('trans.ProvinceCode')}}" class="form-control"    name="ProvinceCode"  required=""/> 
          </div>
