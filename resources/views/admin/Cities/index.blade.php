...
@section('content')
                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase"> {{trans('trans.Cities')}}</span>
                                        </div>
                                    ...
                                    <div class="portlet-body">
                                        <div class="table-toolbar">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="btn-group">
                 <a id="sample_editable_1_new" class="btn sbold green" href="{{url('/')}}/adminShowCities/create"> {{trans('trans.Add New')}}
                                         ...
                                         <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th> {{trans('trans.name_ar')}}  </th>
                                                    <th> {{trans('trans.ProvinceCode')}}  </th>
    ...
    <th> {{trans('trans.status')}} </th>
                                        ...
                                        <div class="switch">
                                            <label>
                                                <input onchange="update_active(this)" value="{{ $City->id }}"
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-left" role="menu">
                                                                ...
                                                                <li>
                     <a href="{{url('/')}}/adminShowCities/{{$City->id}}/edit">
                                                                        <i class="icon-docs"></i> 
                                                    {{trans('trans.edit')}}
                                                                </a>
                                                                </li>
                                                                <li>
                                              <a href="{{url('/')}}/adminShowCities/{{$City->id}}/destroy">
                                                                        <i class="icon-tag"></i>
                                     {{trans('trans.delete')}}
                                                                         </a>
                                                                </li>
    ...
    <script type="text/javascript">
                function update_active(el) {
                    ...
                    $.post('{{  url("/")}}/adminShowCities/actived', {
                        _token: '{{ csrf_token() }}',
                        id: el.value,
                        status: status
                    }, function (data) {
