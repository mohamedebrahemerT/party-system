...
@section('content')
                  ...
                  <form role="form" action="{{url('/')}}/currency" method="POST" enctype="multipart/form-data">
                    @csrf
           ...
           <div class="form-group col-md-4">
              ...
              <input type="text" placeholder="{{trans('trans.exchange_rate')}}" class="form-control"    name="exchange_rate"  required=""/> 
          </div>
                    </div>
