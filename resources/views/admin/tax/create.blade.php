...
@section('content')
                  ...
                  <form role="form" action="{{url('/')}}/tax" method="POST" enctype="multipart/form-data">
                    @csrf
           ...
           <div class="form-group col-md-6">
              ...
              <input type="text" placeholder="{{trans('trans.rate')}}" class="form-control"    name="rate"  required=""/> 
          </div>
