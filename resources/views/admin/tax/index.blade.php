...
@section('content')
                                    ...
                                    <div class="portlet-body">
                                        <div class="table-toolbar">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="btn-group">
                 <a id="sample_editable_1_new" class="btn sbold green" href="{{url('/')}}/tax/create"> {{trans('trans.Add New')}}
    ...
    <th> {{trans('trans.status')}} </th>
                                    ...
                                    <td class="text-lg-center">
                                        <div class="switch">
                                            <label>
                                                <input onchange="update_active(this)" value="{{ $tax->id }}"
                                                       type="checkbox" <?php if ($tax->status == 1) echo "checked";?> >
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-left" role="menu">
                                                                ...
                                                                <li>
                     <a href="{{url('/')}}/tax/{{$tax->id}}/edit">
                                                                        <i class="icon-docs"></i> 
                                                    {{trans('trans.edit')}}
                                                                </a>
                                                                </li>
                                                                <li>
                                              <a href="{{url('/')}}/tax/{{$tax->id}}/destroy">
                                                                        <i class="icon-tag"></i>
                                     {{trans('trans.delete')}}
                                                                         </a>
                                                                </li>
